...
const slangData = [
    ...
    // ============================================
    { id: "gday", term: "G'day", meaning: "Hello / Good day", example: "G'day mate, how ya going?", category: "greetings", difficulty: "beginner", termEmotion: "(happy)", exampleEmotion: "(happy)" },
    ...
    { id: "no-wuckas", term: "No wuckas", meaning: "No worries (shortened slang)", example: "Can you help me move? — No wuckas, mate.", category: "expressions", difficulty: "intermediate", termEmotion: "(relaxed)", exampleEmotion: "(relaxed)" },
    ...
    { id: "hooroo", term: "Hooroo", meaning: "Goodbye (old-fashioned)", example: "Hooroo mate, see ya tomorrow!", category: "greetings", difficulty: "advanced", termEmotion: "(happy)", exampleEmotion: "(happy)" },
    ...
    { id: "good-onya", term: "Good onya", meaning: "Good for you / Well done", example: "You got the job? Good onya!", category: "expressions", difficulty: "beginner", termEmotion: "(proud)", exampleEmotion: "(excited)(proud)" },
    { id: "yeah-nah", term: "Yeah, nah", meaning: "No (polite disagreement)", example: "Want another beer? — Yeah, nah, I'm driving.", category: "expressions", difficulty: "beginner", termEmotion: "(relaxed)", exampleEmotion: "(relaxed)" },
    ...
    { id: "oath", term: "Oath", meaning: "Yes, absolutely (affirmation)", example: "Are you coming? — Oath!", category: "expressions", difficulty: "intermediate", termEmotion: "(confident)", exampleEmotion: "(confident)(excited)" },
    ...
    { id: "oi", term: "Oi", meaning: "Hey! / Attention getter", example: "Oi! Over here!", category: "expressions", difficulty: "beginner", termEmotion: "(shouting)", exampleEmotion: "(shouting)(excited)" },

    // ============================================
    // TIME & PLACE
    // ============================================
    { id: "arvo", term: "Arvo", meaning: "Afternoon", example: "I'll see you this arvo at the pub.", category: "time", difficulty: "beginner", termEmotion: "(relaxed)", exampleEmotion: "(relaxed)" },
    { id: "sparrows-fart", term: "Sparrow's fart", meaning: "Very early morning / Dawn", example: "We have to leave at sparrow's fart to beat traffic.", category: "time", difficulty: "advanced", termEmotion: "(tired)", exampleEmotion: "(tired)(sighing)" },
    ...
    { id: "smoko", term: "Smoko", meaning: "Smoke break / Short work break", example: "I'll finish this after smoko.", category: "time", difficulty: "intermediate", termEmotion: "(relaxed)", exampleEmotion: "(relaxed)" },

    { id: "servo", term: "Servo", meaning: "Service station / Gas station", example: "Pull into the servo, we need petrol.", category: "places", difficulty: "beginner", termEmotion: "(relaxed)", exampleEmotion: "(relaxed)" },
    { id: "bottle-o", term: "Bottle-o", meaning: "Liquor store / Bottle shop", example: "I'll grab some beers from the bottle-o.", category: "places", difficulty: "beginner", termEmotion: "(relaxed)", exampleEmotion: "(happy)" },
    ...
    { id: "bunnings", term: "Bunnings", meaning: "Hardware store (famous for sausage sizzles)", example: "Let's go to Bunnings for a snag and some screws.", category: "places", difficulty: "beginner", termEmotion: "(happy)", exampleEmotion: "(excited)" },
    { id: "woop-woop", term: "Woop Woop", meaning: "Middle of nowhere / Remote area", example: "They live out in Woop Woop, hours from the city.", category: "places", difficulty: "intermediate", termEmotion: "(amused)", exampleEmotion: "(amused)" },
    ...
    { id: "dunny", term: "Dunny", meaning: "Toilet (especially outdoor)", example: "Where's the dunny?", category: "places", difficulty: "intermediate", termEmotion: "(relaxed)", exampleEmotion: "(curious)" },
    { id: "loo", term: "Loo", meaning: "Toilet", example: "I need to use the loo.", category: "places", difficulty: "beginner", termEmotion: "(relaxed)", exampleEmotion: "(relaxed)" },
    ...
    { id: "deli", term: "Deli", meaning: "Corner store (WA)", example: "The deli's just around the corner.", category: "places", difficulty: "intermediate", termEmotion: "(relaxed)", exampleEmotion: "(relaxed)" },

    // ============================================
    // PEOPLE
    // ============================================
    { id: "mate", term: "Mate", meaning: "Friend / Buddy (or anyone really)", example: "Thanks mate, you're a legend.", category: "people", difficulty: "beginner", termEmotion: "(friendly)", exampleEmotion: "(grateful)(happy)" },
    ...
    { id: "sook", term: "Sook", meaning: "Someone who complains a lot / Crybaby", example: "Stop being such a sook!", category: "people", difficulty: "intermediate", termEmotion: "(frustrated)", exampleEmotion: "(frustrated)" },
    { id: "bushie", term: "Bushie", meaning: "Country person / Someone from rural areas", example: "He's a bushie, grew up on a station.", category: "people", difficulty: "intermediate", termEmotion: "(relaxed)", exampleEmotion: "(relaxed)" },
    { id: "tradie", term: "Tradie", meaning: "Tradesperson (plumber, electrician, etc.)", example: "The tradie fixed our plumbing yesterday.", category: "people", difficulty: "beginner", termEmotion: "(relaxed)", exampleEmotion: "(satisfied)" },
    { id: "postie", term: "Postie", meaning: "Postal worker / Mail carrier", example: "The postie just delivered a parcel.", category: "people", difficulty: "beginner", termEmotion: "(relaxed)", exampleEmotion: "(happy)" },
    { id: "garbo", term: "Garbo", meaning: "Garbage collector", example: "The garbo comes every Tuesday.", category: "people", difficulty: "intermediate", termEmotion: "(relaxed)", exampleEmotion: "(relaxed)" },
    { id: "ambo", term: "Ambo", meaning: "Ambulance / Paramedic", example: "Call an ambo, quick!", category: "people", difficulty: "intermediate", termEmotion: "(relaxed)", exampleEmotion: "(urgent)(in a hurry tone)" },
    { id: "muso", term: "Muso", meaning: "Musician", example: "He's a talented muso, plays in a band.", category: "people", difficulty: "intermediate", termEmotion: "(relaxed)", exampleEmotion: "(impressed)" },

    // ============================================
    // FOOD & DRINK
    // ============================================
    { id: "snag", term: "Snag", meaning: "Sausage", example: "Chuck a few snags on the barbie.", category: "food", difficulty: "beginner", termEmotion: "(happy)", exampleEmotion: "(happy)" },
    ...
    { id: "esky", term: "Esky", meaning: "Cooler / Ice box", example: "The drinks are in the esky.", category: "food", difficulty: "beginner", termEmotion: "(relaxed)", exampleEmotion: "(relaxed)" },
    { id: "brekkie", term: "Brekkie", meaning: "Breakfast", example: "Let's meet for brekkie at 9.", category: "food", difficulty: "beginner", termEmotion: "(happy)", exampleEmotion: "(friendly)" },
    { id: "sanga", term: "Sanga", meaning: "Sandwich", example: "I made a vegemite sanga for lunch.", category: "food", difficulty: "intermediate", termEmotion: "(relaxed)", exampleEmotion: "(satisfied)" },
    { id: "chook", term: "Chook", meaning: "Chicken", example: "I'll pick up a roast chook for dinner.", category: "food", difficulty: "intermediate", termEmotion: "(relaxed)", exampleEmotion: "(relaxed)" },
    { id: "cuppa", term: "Cuppa", meaning: "Cup of tea or coffee", example: "Come in and have a cuppa.", category: "food", difficulty: "beginner", termEmotion: "(relaxed)", exampleEmotion: "(friendly)(warm)" },
    ...
    { id: "coldie", term: "Coldie", meaning: "Cold beer", example: "Grab us a coldie from the esky.", category: "food", difficulty: "intermediate", termEmotion: "(satisfied)", exampleEmotion: "(relaxed)" },
    { id: "tinnie", term: "Tinnie", meaning: "Can of beer / Small aluminum boat", example: "Pass us a tinnie from the esky.", category: "food", difficulty: "intermediate", termEmotion: "(relaxed)", exampleEmotion: "(relaxed)" },
    { id: "stubby", term: "Stubby", meaning: "Small bottle of beer", example: "Grab a stubby and come sit down.", category: "food", difficulty: "intermediate", termEmotion: "(relaxed)", exampleEmotion: "(friendly)" },
    ...
    { id: "bikkie", term: "Bikkie", meaning: "Biscuit / Cookie", example: "Want a bikkie with your tea?", category: "food", difficulty: "intermediate", termEmotion: "(happy)", exampleEmotion: "(friendly)" },
    { id: "choccy", term: "Choccy", meaning: "Chocolate", example: "I could really go for some choccy right now.", category: "food", difficulty: "intermediate", termEmotion: "(happy)", exampleEmotion: "(longing)" },
    ...
    { id: "avo", term: "Avo", meaning: "Avocado", example: "Smashed avo on toast is a classic brekkie.", category: "food", difficulty: "beginner", termEmotion: "(relaxed)", exampleEmotion: "(satisfied)" },
    ...
    // ACTIONS & VERBS
    // ============================================
    { id: "chuck", term: "Chuck", meaning: "Throw / Put", example: "Chuck your bag in the back.", category: "actions", difficulty: "beginner", termEmotion: "(relaxed)", exampleEmotion: "(relaxed)" },
    ...
    { id: "chuck-a-uey", term: "Chuck a U-ey", meaning: "Make a U-turn", example: "Missed the turn, chuck a U-ey.", category: "actions", difficulty: "intermediate", termEmotion: "(relaxed)", exampleEmotion: "(relaxed)" },
    ...
    { id: "choof-off", term: "Choof off", meaning: "Leave / Depart", example: "I better choof off, it's getting late.", category: "actions", difficulty: "intermediate", termEmotion: "(relaxed)", exampleEmotion: "(relaxed)" },
    ...
    { id: "come-a-cropper", term: "Come a cropper", meaning: "Fall over / Fail badly", example: "He came a cropper on his bike.", category: "actions", difficulty: "advanced", termEmotion: "(worried)", exampleEmotion: "(sympathetic)" },
    { id: "hard-yakka", term: "Hard yakka", meaning: "Hard work", example: "Building that deck was hard yakka.", category: "actions", difficulty: "intermediate", termEmotion: "(exhausted)", exampleEmotion: "(exhausted)(proud)" },
    ...
    { id: "chockers", term: "Chockers", meaning: "Completely full / Packed", example: "The train was chockers this morning.", category: "descriptive", difficulty: "intermediate", termEmotion: "(frustrated)", exampleEmotion: "(frustrated)" },
    ...
    { id: "stonkered", term: "Stonkered", meaning: "Exhausted or drunk", example: "I'm absolutely stonkered after that hike.", category: "descriptive", difficulty: "advanced", termEmotion: "(exhausted)", exampleEmotion: "(exhausted)" },
    ...
    { id: "full-as-a-goog", term: "Full as a goog", meaning: "Very drunk or very full from eating", example: "He was full as a goog after dinner.", category: "descriptive", difficulty: "advanced", termEmotion: "(satisfied)", exampleEmotion: "(satisfied)" },
    ...
    { id: "daggy", term: "Daggy", meaning: "Unfashionable / Dorky but endearing", example: "That outfit is a bit daggy.", category: "descriptive", difficulty: "intermediate", termEmotion: "(amused)", exampleEmotion: "(amused)" },
    ...
    { id: "aggro", term: "Aggro", meaning: "Aggressive / Angry", example: "Don't get aggro with me!", category: "descriptive", difficulty: "intermediate", termEmotion: "(angry)", exampleEmotion: "(frustrated)" },
    { id: "spewin", term: "Spewin'", meaning: "Very upset / Angry", example: "I was spewin' when I lost my wallet.", category: "descriptive", difficulty: "intermediate", termEmotion: "(upset)", exampleEmotion: "(upset)" },
    { id: "devo", term: "Devo", meaning: "Devastated", example: "I was devo when they cancelled the concert.", category: "descriptive", difficulty: "intermediate", termEmotion: "(sad)", exampleEmotion: "(sad)(disappointed)" },
    ...
    { id: "mad", term: "Mad", meaning: "Great / Awesome (not angry)", example: "That party was mad!", category: "descriptive", difficulty: "intermediate", termEmotion: "(excited)", exampleEmotion: "(excited)" },
    ...
    // THINGS & OBJECTS
    // ============================================
    { id: "thongs", term: "Thongs", meaning: "Flip-flops (NOT underwear!)", example: "Wear your thongs to the beach.", category: "things", difficulty: "beginner", termEmotion: "(relaxed)", exampleEmotion: "(relaxed)" },
    { id: "sunnies", term: "Sunnies", meaning: "Sunglasses", example: "Don't forget your sunnies, it's bright out.", category: "things", difficulty: "beginner", termEmotion: "(relaxed)", exampleEmotion: "(helpful)" },
    { id: "trackies", term: "Trackies", meaning: "Tracksuit pants / Sweatpants", example: "I'm just lounging around in my trackies today.", category: "things", difficulty: "beginner", termEmotion: "(relaxed)", exampleEmotion: "(relaxed)" },
    ...
    { id: "cossie", term: "Cossie", meaning: "Swimming costume (NSW)", example: "Don't forget your cossie for the beach.", category: "things", difficulty: "intermediate", termEmotion: "(relaxed)", exampleEmotion: "(helpful)" },
    ...
    { id: "bathers", term: "Bathers", meaning: "Swimming costume (VIC)", example: "I need to buy new bathers for summer.", category: "things", difficulty: "intermediate", termEmotion: "(relaxed)", exampleEmotion: "(relaxed)" },
    { id: "ute", term: "Ute", meaning: "Utility vehicle / Pickup truck", example: "He's got all his tools in the back of his ute.", category: "things", difficulty: "beginner", termEmotion: "(relaxed)", exampleEmotion: "(relaxed)" },
    { id: "akubra", term: "Akubra", meaning: "Wide-brimmed hat", example: "He wore his Akubra in the outback.", category: "things", difficulty: "intermediate", termEmotion: "(relaxed)", exampleEmotion: "(relaxed)" },
    { id: "swag", term: "Swag", meaning: "Camping bedroll / Sleeping bag", example: "We rolled out our swags under the stars.", category: "things", difficulty: "intermediate", termEmotion: "(relaxed)", exampleEmotion: "(relaxed)(nostalgic)" },
    ...
    { id: "roo-bar", term: "Roo bar", meaning: "Bull bar on a vehicle", example: "Good thing I had a roo bar, hit a roo last night.", category: "things", difficulty: "intermediate", termEmotion: "(relaxed)", exampleEmotion: "(relieved)" },
    { id: "rego", term: "Rego", meaning: "Vehicle registration", example: "My rego is due next month.", category: "things", difficulty: "beginner", termEmotion: "(relaxed)", exampleEmotion: "(sighing)" },
    { id: "ciggie", term: "Ciggie", meaning: "Cigarette", example: "He went outside for a ciggie.", category: "things", difficulty: "intermediate", termEmotion: "(relaxed)", exampleEmotion: "(relaxed)" },
    { id: "prezzie", term: "Prezzie", meaning: "Present / Gift", example: "I got some great Chrissie prezzies!", category: "things", difficulty: "intermediate", termEmotion: "(happy)", exampleEmotion: "(excited)(happy)" },
    { id: "chrissie", term: "Chrissie", meaning: "Christmas", example: "What are your plans for Chrissie?", category: "things", difficulty: "intermediate", termEmotion: "(happy)", exampleEmotion: "(curious)(friendly)" },
    { id: "rello", term: "Rello", meaning: "Relative", example: "We're visiting the rellos this weekend.", category: "things", difficulty: "intermediate", termEmotion: "(relaxed)", exampleEmotion: "(relaxed)" },
    { id: "doco", term: "Doco", meaning: "Documentary", example: "There's a good doco on SBS tonight.", category: "things", difficulty: "intermediate", termEmotion: "(relaxed)", exampleEmotion: "(interested)" },
    { id: "facey", term: "Facey", meaning: "Facebook", example: "Did you see the photos on Facey?", category: "things", difficulty: "intermediate", termEmotion: "(relaxed)", exampleEmotion: "(curious)" },
    { id: "byo", term: "BYO", meaning: "Bring your own (usually alcohol)", example: "It's a BYO barbecue, bring your own drinks.", category: "things", difficulty: "beginner", termEmotion: "(relaxed)", exampleEmotion: "(friendly)" },
    ...
    // WILDLIFE & NATURE
    // ============================================
    { id: "mozzie", term: "Mozzie", meaning: "Mosquito", example: "The mozzies are terrible tonight!", category: "wildlife", difficulty: "beginner", termEmotion: "(annoyed)", exampleEmotion: "(frustrated)" },
    { id: "roo", term: "Roo", meaning: "Kangaroo", example: "Watch out for roos on the road at night.", category: "wildlife", difficulty: "beginner", termEmotion: "(relaxed)", exampleEmotion: "(cautious)" },
    { id: "cocky", term: "Cocky", meaning: "Cockatoo", example: "The cockies are making a racket this morning.", category: "wildlife", difficulty: "intermediate", termEmotion: "(relaxed)", exampleEmotion: "(annoyed)(amused)" },
    ...
    { id: "bluey", term: "Bluey", meaning: "Blue heeler dog / Redheaded person", example: "My bluey is the best cattle dog.", category: "wildlife", difficulty: "intermediate", termEmotion: "(affectionate)", exampleEmotion: "(proud)(affectionate)" },
    ...
    { id: "reg-grundys", term: "Reg Grundys", meaning: "Undies / Underwear (rhyming slang)", example: "He was walking around in his Reg Grundys!", category: "rhyming", difficulty: "advanced", termEmotion: "(amused)", exampleEmotion: "(amused)(laughing)" },
    { id: "barry-crocker", term: "Barry Crocker", meaning: "Shocker / Bad day (rhyming slang)", example: "I had an absolute Barry Crocker today.", category: "rhyming", difficulty: "advanced", termEmotion: "(amused)", exampleEmotion: "(exhausted)(sighing)" },
    { id: "harold-holt", term: "Harold Holt", meaning: "Bolt / Leave quickly (rhyming slang)", example: "He did a Harold Holt when the cops arrived.", category: "rhyming", difficulty: "advanced", termEmotion: "(amused)", exampleEmotion: "(amused)" },
    ...
    // ============================================
    { id: "as-cross-as-a-frog", term: "Cross as a frog in a sock", meaning: "Very angry", example: "She was as cross as a frog in a sock.", category: "expressions", difficulty: "advanced", termEmotion: "(angry)", exampleEmotion: "(amused)" },
    ...
    { id: "built-like-brick-dunny", term: "Built like a brick dunny", meaning: "Very solidly built", example: "That rugby player is built like a brick dunny.", category: "expressions", difficulty: "advanced", termEmotion: "(impressed)", exampleEmotion: "(impressed)" },
    ...
    { id: "charges-wounded-bull", term: "Charges like a wounded bull", meaning: "Very expensive", example: "That mechanic charges like a wounded bull.", category: "expressions", difficulty: "advanced", termEmotion: "(frustrated)", exampleEmotion: "(frustrated)" },
    { id: "couldnt-organise-chook-raffle", term: "Couldn't organise a chook raffle", meaning: "Very disorganised", example: "He couldn't organise a chook raffle.", category: "expressions", difficulty: "advanced", termEmotion: "(sarcastic)", exampleEmotion: "(sarcastic)(sighing)" },
    { id: "not-bowl-of-rice", term: "Not my bowl of rice", meaning: "Not my preference / Not my thing", example: "Cricket's not really my bowl of rice.", category: "expressions", difficulty: "intermediate", termEmotion: "(relaxed)", exampleEmotion: "(relaxed)" },
