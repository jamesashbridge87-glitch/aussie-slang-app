...
const slangData = [
    ...
    // ============================================
    { id: "gday", term: "G'day", meaning: "Hello / Good day", example: "G'day mate, how ya going?", category: "greetings", difficulty: "beginner", termEmotion: "(happy)", exampleEmotion: "(happy)", termPronunciation: "Guh-day" },
    ...
    // TIME & PLACE
    // ============================================
    { id: "arvo", term: "Arvo", meaning: "Afternoon", example: "I'll see you this arvo at the pub.", category: "time", difficulty: "beginner", termEmotion: "(relaxed)", exampleEmotion: "(relaxed)", termPronunciation: "Ar-voh" },
    ...
    { id: "bottle-o", term: "Bottle-o", meaning: "Liquor store / Bottle shop", example: "I'll grab some beers from the bottle-o.", category: "places", difficulty: "beginner", termEmotion: "(relaxed)", exampleEmotion: "(happy)", termPronunciation: "Bottle-oh" },
    ...
    { id: "dunny", term: "Dunny", meaning: "Toilet (especially outdoor)", example: "Where's the dunny?", category: "places", difficulty: "intermediate", termEmotion: "(relaxed)", exampleEmotion: "(curious)", termPronunciation: "Dun-ee" },
    ...
    { id: "tradie", term: "Tradie", meaning: "Tradesperson (plumber, electrician, etc.)", example: "The tradie fixed our plumbing yesterday.", category: "people", difficulty: "beginner", termEmotion: "(relaxed)", exampleEmotion: "(satisfied)", termPronunciation: "Tray-dee" },
    ...
    { id: "garbo", term: "Garbo", meaning: "Garbage collector", example: "The garbo comes every Tuesday.", category: "people", difficulty: "intermediate", termEmotion: "(relaxed)", exampleEmotion: "(relaxed)", termPronunciation: "Gar-boh" },
    { id: "ambo", term: "Ambo", meaning: "Ambulance / Paramedic", example: "Call an ambo, quick!", category: "people", difficulty: "intermediate", termEmotion: "(relaxed)", exampleEmotion: "(urgent)(in a hurry tone)", termPronunciation: "Am-boh" },
    ...
    { id: "esky", term: "Esky", meaning: "Cooler / Ice box", example: "The drinks are in the esky.", category: "food", difficulty: "beginner", termEmotion: "(relaxed)", exampleEmotion: "(relaxed)", termPronunciation: "Ess-key" },
    ...
    { id: "coldie", term: "Coldie", meaning: "Cold beer", example: "Grab us a coldie from the esky.", category: "food", difficulty: "intermediate", termEmotion: "(satisfied)", exampleEmotion: "(relaxed)", termPronunciation: "Cold-ee" },
    { id: "tinnie", term: "Tinnie", meaning: "Can of beer / Small aluminum boat", example: "Pass us a tinnie from the esky.", category: "food", difficulty: "intermediate", termEmotion: "(relaxed)", exampleEmotion: "(relaxed)", termPronunciation: "Tin-ee" },
    { id: "stubby", term: "Stubby", meaning: "Small bottle of beer", example: "Grab a stubby and come sit down.", category: "food", difficulty: "intermediate", termEmotion: "(relaxed)", exampleEmotion: "(friendly)", termPronunciation: "Stub-ee" },
    ...
    { id: "bikkie", term: "Bikkie", meaning: "Biscuit / Cookie", example: "Want a bikkie with your tea?", category: "food", difficulty: "intermediate", termEmotion: "(happy)", exampleEmotion: "(friendly)", termPronunciation: "Bik-ee" },
    ...
    { id: "avo", term: "Avo", meaning: "Avocado", example: "Smashed avo on toast is a classic brekkie.", category: "food", difficulty: "beginner", termEmotion: "(relaxed)", exampleEmotion: "(satisfied)", termPronunciation: "Av-oh" },
    ...
    { id: "hard-yakka", term: "Hard yakka", meaning: "Hard work", example: "Building that deck was hard yakka.", category: "actions", difficulty: "intermediate", termEmotion: "(exhausted)", exampleEmotion: "(exhausted)(proud)", termPronunciation: "Hard yak-a" },
    ...
    { id: "aggro", term: "Aggro", meaning: "Aggressive / Angry", example: "Don't get aggro with me!", category: "descriptive", difficulty: "intermediate", termEmotion: "(angry)", exampleEmotion: "(frustrated)", termPronunciation: "Ag-roh" },
    { id: "spewin", term: "Spewin'", meaning: "Very upset / Angry", example: "I was spewin' when I lost my wallet.", category: "descriptive", difficulty: "intermediate", termEmotion: "(upset)", exampleEmotion: "(upset)", termPronunciation: "Spew-in" },
    { id: "devo", term: "Devo", meaning: "Devastated", example: "I was devo when they cancelled the concert.", category: "descriptive", difficulty: "intermediate", termEmotion: "(sad)", exampleEmotion: "(sad)(disappointed)", termPronunciation: "Dev-oh" },
    ...
    { id: "akubra", term: "Akubra", meaning: "Wide-brimmed hat", example: "He wore his Akubra in the outback.", category: "things", difficulty: "intermediate", termEmotion: "(relaxed)", exampleEmotion: "(relaxed)", termPronunciation: "Ah-koo-bra" },
    ...
    { id: "rego", term: "Rego", meaning: "Vehicle registration", example: "My rego is due next month.", category: "things", difficulty: "beginner", termEmotion: "(relaxed)", exampleEmotion: "(sighing)", termPronunciation: "Rej-oh" },
    ...
    { id: "rello", term: "Rello", meaning: "Relative", example: "We're visiting the rellos this weekend.", category: "things", difficulty: "intermediate", termEmotion: "(relaxed)", exampleEmotion: "(relaxed)", termPronunciation: "Rell-oh" },
    ...
    { id: "byo", term: "BYO", meaning: "Bring your own (usually alcohol)", example: "It's a BYO barbecue, bring your own drinks.", category: "things", difficulty: "beginner", termEmotion: "(relaxed)", exampleEmotion: "(friendly)", termPronunciation: "Bee Why Oh" },
    ...
    // WILDLIFE & NATURE
    // ============================================
    { id: "mozzie", term: "Mozzie", meaning: "Mosquito", example: "The mozzies are terrible tonight!", category: "wildlife", difficulty: "beginner", termEmotion: "(annoyed)", exampleEmotion: "(frustrated)", termPronunciation: "Moz-ee" },
    ...
    { id: "cocky", term: "Cocky", meaning: "Cockatoo", example: "The cockies are making a racket this morning.", category: "wildlife", difficulty: "intermediate", termEmotion: "(relaxed)", exampleEmotion: "(annoyed)(amused)", termPronunciation: "Cock-ee" },
    ...
    { id: "bluey", term: "Bluey", meaning: "Blue heeler dog / Redheaded person", example: "My bluey is the best cattle dog.", category: "wildlife", difficulty: "intermediate", termEmotion: "(affectionate)", exampleEmotion: "(proud)(affectionate)", termPronunciation: "Blue-ee" },
