...
const slangData = [
    ...
    { id: "no-wuckas", term: "No wuckas", meaning: "No worries (shortened slang)", example: "Can you help me move? — No wuckas, mate.", category: "expressions", difficulty: "intermediate" },
    { id: "no-dramas", term: "No dramas", meaning: "No problem / All good", example: "Sorry I'm late. — No dramas!", category: "expressions", difficulty: "beginner" },
    ...
    { id: "shes-apples", term: "She's apples", meaning: "Everything is fine", example: "How's the car running? — She's apples!", category: "expressions", difficulty: "intermediate" },
    ...
    { id: "sweet-as", term: "Sweet as", meaning: "Cool / No problem / Great", example: "You need a lift? Sweet as.", category: "expressions", difficulty: "beginner" },
    ...
    { id: "hooroo", term: "Hooroo", meaning: "Goodbye (old-fashioned)", example: "Hooroo mate, see ya tomorrow!", category: "greetings", difficulty: "advanced" },
    ...
    { id: "good-onya", term: "Good onya", meaning: "Good for you / Well done", example: "You got the job? Good onya!", category: "expressions", difficulty: "beginner" },
    { id: "yeah-nah", term: "Yeah, nah", meaning: "No (polite disagreement)", example: "Want another beer? — Yeah, nah, I'm driving.", category: "expressions", difficulty: "beginner" },
    { id: "nah-yeah", term: "Nah, yeah", meaning: "Yes (casual agreement)", example: "Are you coming to the party? — Nah, yeah, I'll be there.", category: "expressions", difficulty: "beginner" },
    { id: "oath", term: "Oath", meaning: "Yes, absolutely (affirmation)", example: "Are you coming? — Oath!", category: "expressions", difficulty: "intermediate" },
    ...
    { id: "oi", term: "Oi", meaning: "Hey! / Attention getter", example: "Oi! Over here!", category: "expressions", difficulty: "beginner" },
    ...
    { id: "servo", term: "Servo", meaning: "Service station / Gas station", example: "Pull into the servo, we need petrol.", category: "places", difficulty: "beginner" },
    { id: "bottle-o", term: "Bottle-o", meaning: "Liquor store / Bottle shop", example: "I'll grab some beers from the bottle-o.", category: "places", difficulty: "beginner" },
    ...
    { id: "coles", term: "Coles", meaning: "Coles supermarket", example: "Coles has the specials on this week.", category: "places", difficulty: "beginner" },
    ...
    { id: "dunny", term: "Dunny", meaning: "Toilet (especially outdoor)", example: "Where's the dunny?", category: "places", difficulty: "intermediate" },
    { id: "loo", term: "Loo", meaning: "Toilet", example: "I need to use the loo.", category: "places", difficulty: "beginner" },
    { id: "milkbar", term: "Milkbar", meaning: "Corner store (VIC/SA)", example: "I'm going to the milkbar for some lollies.", category: "places", difficulty: "intermediate" },
    { id: "deli", term: "Deli", meaning: "Corner store (WA)", example: "The deli's just around the corner.", category: "places", difficulty: "intermediate" },
    ...
    { id: "dag", term: "Dag", meaning: "Silly but endearing person / Nerd", example: "You're such a dag!", category: "people", difficulty: "intermediate" },
    ...
    { id: "ratbag", term: "Ratbag", meaning: "Mischievous person / Troublemaker", example: "He's a bit of a ratbag.", category: "people", difficulty: "intermediate" },
    ...
    { id: "sook", term: "Sook", meaning: "Someone who complains a lot / Crybaby", example: "Stop being such a sook!", category: "people", difficulty: "intermediate" },
    { id: "bushie", term: "Bushie", meaning: "Country person / Someone from rural areas", example: "He's a bushie, grew up on a station.", category: "people", difficulty: "intermediate" },
    { id: "tradie", term: "Tradie", meaning: "Tradesperson (plumber, electrician, etc.)", example: "The tradie fixed our plumbing yesterday.", category: "people", difficulty: "beginner" },
    { id: "postie", term: "Postie", meaning: "Postal worker / Mail carrier", example: "The postie just delivered a parcel.", category: "people", difficulty: "beginner" },
    { id: "garbo", term: "Garbo", meaning: "Garbage collector", example: "The garbo comes every Tuesday.", category: "people", difficulty: "intermediate" },
    { id: "ambo", term: "Ambo", meaning: "Ambulance / Paramedic", example: "Call an ambo, quick!", category: "people", difficulty: "intermediate" },
    { id: "muso", term: "Muso", meaning: "Musician", example: "He's a talented muso, plays in a band.", category: "people", difficulty: "intermediate" },
    ...
    { id: "esky", term: "Esky", meaning: "Cooler / Ice box", example: "The drinks are in the esky.", category: "food", difficulty: "beginner" },
    ...
    { id: "long-black", term: "Long black", meaning: "Double espresso with hot water", example: "I'll have a long black, please.", category: "food", difficulty: "beginner" },
    { id: "flat-white", term: "Flat white", meaning: "Espresso with steamed milk", example: "Can I get a flat white?", category: "food", difficulty: "beginner" },
    ...
    { id: "chuck-a-uey", term: "Chuck a U-ey", meaning: "Make a U-turn", example: "Missed the turn, chuck a U-ey.", category: "actions", difficulty: "intermediate" },
    ...
    { id: "take-a-squiz", term: "Take a squiz", meaning: "Take a look", example: "Can you take a squiz at this email?", category: "actions", difficulty: "intermediate" },
    ...
    { id: "choof-off", term: "Choof off", meaning: "Leave / Depart", example: "I better choof off, it's getting late.", category: "actions", difficulty: "intermediate" },
    ...
    { id: "hard-yakka", term: "Hard yakka", meaning: "Hard work", example: "Building that deck was hard yakka.", category: "actions", difficulty: "intermediate" },
    ...
    { id: "bonza", term: "Bonza", meaning: "Excellent / Great", example: "That's a bonza idea!", category: "descriptive", difficulty: "intermediate" },
    { id: "grouse", term: "Grouse", meaning: "Great / Excellent (VIC)", example: "That was a grouse party!", category: "descriptive", difficulty: "intermediate" },
    ...
    { id: "chockers", term: "Chockers", meaning: "Completely full / Packed", example: "The train was chockers this morning.", category: "descriptive", difficulty: "intermediate" },
    ...
    { id: "stonkered", term: "Stonkered", meaning: "Exhausted or drunk", example: "I'm absolutely stonkered after that hike.", category: "descriptive", difficulty: "advanced" },
    ...
    { id: "full-as-a-goog", term: "Full as a goog", meaning: "Very drunk or very full from eating", example: "He was full as a goog after dinner.", category: "descriptive", difficulty: "advanced" },
    ...
    { id: "cactus", term: "Cactus", meaning: "Broken / Not working", example: "My phone's cactus, need a new one.", category: "descriptive", difficulty: "intermediate" },
    ...
    { id: "daggy", term: "Daggy", meaning: "Unfashionable / Dorky but endearing", example: "That outfit is a bit daggy.", category: "descriptive", difficulty: "intermediate" },
    ...
    { id: "spewin", term: "Spewin'", meaning: "Very upset / Angry", example: "I was spewin' when I lost my wallet.", category: "descriptive", difficulty: "intermediate" },
    { id: "devo", term: "Devo", meaning: "Devastated", example: "I was devo when they cancelled the concert.", category: "descriptive", difficulty: "intermediate" },
    ...
    // THINGS & OBJECTS
    // ============================================
    { id: "thongs", term: "Thongs", meaning: "Flip-flops (NOT underwear!)", example: "Wear your thongs to the beach.", category: "things", difficulty: "beginner" },
    { id: "sunnies", term: "Sunnies", meaning: "Sunglasses", example: "Don't forget your sunnies, it's bright out.", category: "things", difficulty: "beginner" },
    { id: "trackies", term: "Trackies", meaning: "Tracksuit pants / Sweatpants", example: "I'm just lounging around in my trackies today.", category: "things", difficulty: "beginner" },
    ...
    { id: "cossie", term: "Cossie", meaning: "Swimming costume (NSW)", example: "Don't forget your cossie for the beach.", category: "things", difficulty: "intermediate" },
    ...
    { id: "bathers", term: "Bathers", meaning: "Swimming costume (VIC)", example: "I need to buy new bathers for summer.", category: "things", difficulty: "intermediate" },
    { id: "ute", term: "Ute", meaning: "Utility vehicle / Pickup truck", example: "He's got all his tools in the back of his ute.", category: "things", difficulty: "beginner" },
    { id: "akubra", term: "Akubra", meaning: "Wide-brimmed hat", example: "He wore his Akubra in the outback.", category: "things", difficulty: "intermediate" },
    { id: "swag", term: "Swag", meaning: "Camping bedroll / Sleeping bag", example: "We rolled out our swags under the stars.", category: "things", difficulty: "intermediate" },
    ...
    { id: "roo-bar", term: "Roo bar", meaning: "Bull bar on a vehicle", example: "Good thing I had a roo bar, hit a roo last night.", category: "things", difficulty: "intermediate" },
    { id: "rego", term: "Rego", meaning: "Vehicle registration", example: "My rego is due next month.", category: "things", difficulty: "beginner" },
    { id: "ciggie", term: "Ciggie", meaning: "Cigarette", example: "He went outside for a ciggie.", category: "things", difficulty: "intermediate" },
    { id: "prezzie", term: "Prezzie", meaning: "Present / Gift", example: "I got some great Chrissie prezzies!", category: "things", difficulty: "intermediate" },
    { id: "chrissie", term: "Chrissie", meaning: "Christmas", example: "What are your plans for Chrissie?", category: "things", difficulty: "intermediate" },
    { id: "rello", term: "Rello", meaning: "Relative", example: "We're visiting the rellos this weekend.", category: "things", difficulty: "intermediate" },
    { id: "doco", term: "Doco", meaning: "Documentary", example: "There's a good doco on SBS tonight.", category: "things", difficulty: "intermediate" },
    { id: "facey", term: "Facey", meaning: "Facebook", example: "Did you see the photos on Facey?", category: "things", difficulty: "intermediate" },
    { id: "byo", term: "BYO", meaning: "Bring your own (usually alcohol)", example: "It's a BYO barbecue, bring your own drinks.", category: "things", difficulty: "beginner" },

    // ============================================
    // MONEY
    // ============================================
    { id: "bucks", term: "Bucks", meaning: "Dollars", example: "That'll be twenty bucks.", category: "money", difficulty: "beginner" },
    { id: "pineapple", term: "Pineapple", meaning: "$50 note (yellow colour)", example: "Can you break a pineapple?", category: "money", difficulty: "intermediate" },
    { id: "lobster", term: "Lobster", meaning: "$20 note (red colour)", example: "Just got a lobster from the ATM.", category: "money", difficulty: "intermediate" },
    { id: "blue-swimmer", term: "Blue swimmer", meaning: "$10 note (blue colour)", example: "Got any blue swimmers for the parking meter?", category: "money", difficulty: "advanced" },
    ...
    { id: "wombat", term: "Wombat", meaning: "Cute burrowing marsupial", example: "We saw a wombat crossing the road.", category: "wildlife", difficulty: "beginner" },
    ...
    // RHYMING SLANG
    // ============================================
    { id: "captain-cook", term: "Captain Cook", meaning: "Have a look (rhyming slang)", example: "Let me have a Captain Cook at that.", category: "rhyming", difficulty: "advanced" },
    { id: "frog-and-toad", term: "Frog and toad", meaning: "Road (rhyming slang)", example: "Let's hit the frog and toad.", category: "rhyming", difficulty: "advanced" },
    { id: "reg-grundys", term: "Reg Grundys", meaning: "Undies / Underwear (rhyming slang)", example: "He was walking around in his Reg Grundys!", category: "rhyming", difficulty: "advanced" },
    { id: "barry-crocker", term: "Barry Crocker", meaning: "Shocker / Bad day (rhyming slang)", example: "I had an absolute Barry Crocker today.", category: "rhyming", difficulty: "advanced" },
    { id: "harold-holt", term: "Harold Holt", meaning: "Bolt / Leave quickly (rhyming slang)", example: "He did a Harold Holt when the cops arrived.", category: "rhyming", difficulty: "advanced" },
    { id: "john-dory", term: "What's the John Dory?", meaning: "What's the story? (rhyming slang)", example: "So what's the John Dory with the new job?", category: "rhyming", difficulty: "advanced" },
    ...
    { id: "mad-as-a-cut-snake", term: "Mad as a cut snake", meaning: "Very angry or crazy", example: "She was mad as a cut snake when she found out.", category: "expressions", difficulty: "advanced" },
    ...
    { id: "built-like-brick-dunny", term: "Built like a brick dunny", meaning: "Very solidly built", example: "That rugby player is built like a brick dunny.", category: "expressions", difficulty: "advanced" },
    ...
    { id: "carry-on-pork-chop", term: "Carry on like a pork chop", meaning: "Behave ridiculously", example: "Stop carrying on like a pork chop!", category: "expressions", difficulty: "advanced" },
    { id: "charges-wounded-bull", term: "Charges like a wounded bull", meaning: "Very expensive", example: "That mechanic charges like a wounded bull.", category: "expressions", difficulty: "advanced" },
    { id: "couldnt-organise-chook-raffle", term: "Couldn't organise a chook raffle", meaning: "Very disorganised", example: "He couldn't organise a chook raffle.", category: "expressions", difficulty: "advanced" },
    { id: "not-bowl-of-rice", term: "Not my bowl of rice", meaning: "Not my preference / Not my thing", example: "Cricket's not really my bowl of rice.", category: "expressions", difficulty: "intermediate" },
